...
export const careerProfiles: CareerProfile[] = [
  ...
  { id: 'diseno', nombre: 'Diseño de experiencia e interacción', color: '#9b6bb7', resumen: 'Lograr que un sistema se entienda sin manual.', descripcion: 'Integra diseño de interacción, arquitectura de información y experiencia de usuario. Un sistema técnicamente sólido que nadie puede usar también falla.', materias: [23, 16], ambitos: ['Estudios de diseño de producto', 'Áreas de producto digital', 'Agencias', 'Startups'] },
